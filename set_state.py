#!/usr/bin/env python3
"""Update log8-office state (for testing or agent-driven sync).
...
STATE_FILE = (
    os.environ.get("LOG8_OFFICE_STATE_FILE")
    or os.environ.get("STAR_OFFICE_STATE_FILE")  # backward-compat alias
