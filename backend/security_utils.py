#!/usr/bin/env python3
"""Security helper utilities for the log8-office backend.
...
def is_production_mode() -> bool:
    """Return True if LOG8_OFFICE_ENV (or legacy STAR_OFFICE_ENV) or FLASK_ENV is prod/production."""
    env = (os.getenv("LOG8_OFFICE_ENV") or os.getenv("STAR_OFFICE_ENV") or os.getenv("FLASK_ENV") or "").strip().lower()
